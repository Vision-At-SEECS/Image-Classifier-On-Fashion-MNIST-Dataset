# Image-Classifier-On-Fashion-MNIST-Dataset
Image Classifier On Fashion MNIST Dataset. Classifying apparel images in Fashion-MNIST dataset using custom built fully-connected neural network.
